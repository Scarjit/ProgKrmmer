...
public class Card{
    ...
    private static String[] ranks = {"2", "3", "4", "5", "6", "7", "8", "9", "10", "Bube", "Dame", "König", "Ass"};
    private static String[] suits = {"Kreuz", "Pik", "Karo", "Herz"};
    ...
    public static int rankAsInt(String __ranks){
        int RankInt = 0;
...
class rankComparator implements Comparator<Object>{
    public int compare(Object card1, Object card2) throws ClassCastException{
        ...
        if (!((card1 instanceof Card) && (card2 instanceof Card))){
            throw new ClassCastException("[ERROR] A Card object was expeected.  Parameter 1 class: " + card1.getClass() 
