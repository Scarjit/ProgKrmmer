...
public class Spielfeld {
	...
	public static void graphOut(){
		System.out.println("\n");
		String Spacer = "";
		for(int i=0;i<(Größe*17+Größe+1);i++){
			Spacer += "-";
		}
